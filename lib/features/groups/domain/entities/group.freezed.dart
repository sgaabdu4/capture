...
String toString() {
  final _this = this as Group;
  return 'Group(id: ${_this.id}, name: ${_this.name}, description: ${_this.description}, archived: ${_this.archived})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Group&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.archived, archived) || other.archived == archived));
}
...
@override
String toString() {
    return 'Group(id: $id, name: $name, description: $description, archived: $archived)';
}
