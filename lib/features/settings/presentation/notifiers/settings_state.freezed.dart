...
mixin _$SettingsState {
 ...
 bool get loaded; bool get hasTypesafeKey; bool get hasNotionToken; bool get shortcutRegistered; ShortcutProblem? get shortcutProblem; MicPermission get mic;/// Latest download event while the model downloads or after it failed.
...
as MicPermission,modelDownload: freezed == modelDownload ? _self.modelDownload : modelDownload // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.shortcut,_that.modelReady,_that.workspace,_that.loaded,_that.hasTypesafeKey,_that.hasNotionToken,_that.shortcutRegistered,_that.shortcutProblem,_that.mic,_that.modelDownload,_that.savingKey,_that.keyFailure,_that.connecting,_that.notionFailure,_that.pageLinkInvalid);case _:
  return orElse();
...
switch (_that) {
case _SettingsState():
return $default(_that.shortcut,_that.modelReady,_that.workspace,_that.loaded,_that.hasTypesafeKey,_that.hasNotionToken,_that.shortcutRegistered,_that.shortcutProblem,_that.mic,_that.modelDownload,_that.savingKey,_that.keyFailure,_that.connecting,_that.notionFailure,_that.pageLinkInvalid);}
}
...
class _SettingsState extends SettingsState {
  const _SettingsState({required this.shortcut, required this.modelReady, this.workspace, this.loaded = false, this.hasTypesafeKey = false, this.hasNotionToken = false, this.shortcutRegistered = false, this.shortcutProblem, this.mic = MicPermission.undetermined, this.modelDownload, this.savingKey = false, this.keyFailure, this.connecting = false, this.notionFailure, this.pageLinkInvalid = false}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,shortcut,modelReady,workspace,loaded,hasTypesafeKey,hasNotionToken,shortcutRegistered,shortcutProblem,mic,modelDownload,savingKey,keyFailure,connecting,notionFailure,pageLinkInvalid);
}

@override
String toString() {
    return 'SettingsState(shortcut: $shortcut, modelReady: $modelReady, workspace: $workspace, loaded: $loaded, hasTypesafeKey: $hasTypesafeKey, hasNotionToken: $hasNotionToken, shortcutRegistered: $shortcutRegistered, shortcutProblem: $shortcutProblem, mic: $mic, modelDownload: $modelDownload, savingKey: $savingKey, keyFailure: $keyFailure, connecting: $connecting, notionFailure: $notionFailure, pageLinkInvalid: $pageLinkInvalid)';
}
