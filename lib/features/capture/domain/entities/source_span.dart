...
class SourceSpan {
  ...
  factory SourceSpan.fromJson(Map<String, Object?> json) =>
      SourceSpan(json['start']! as int, json['end']! as int, json['excerpt']! as String);
  ...
  Map<String, Object?> toJson() => {'start': start, 'end': end, 'excerpt': excerpt};

  @override
  bool operator ==(Object other) =>
      other is SourceSpan && other.start == start && other.end == end && other.excerpt == excerpt;
