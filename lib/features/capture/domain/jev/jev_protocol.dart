...
JevResult decodeResponse(Object? json, Map<String, JevQuestion> asked) {
  ...
  final usageMap = usage is Map<String, Object?> ? usage : const <String, Object?>{};
  return JevResult(
...
ChoiceAnswer _decodeChoice(String key, Map<String, Object?> answer, Map<String, String?> options) {
...
Map<String, double> _probabilities(String key, Object? raw, Map<String, String?> options) {
...
List<Map<String, JevQuestion>> batchQuestions(String state, Map<String, JevQuestion> questions) {
