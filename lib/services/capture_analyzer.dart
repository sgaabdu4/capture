...
import '../domain/jev/boundary_pass.dart';
import '../domain/jev/classification_pass.dart';
import '../domain/jev/jev_protocol.dart';
import '../domain/jev/thresholds.dart';
import '../domain/models.dart';
import '../domain/proposal/proposal_builder.dart';
import '../domain/source_span.dart';
import '../domain/text/assembly.dart';
import '../domain/text/candidate_splitter.dart';
...
class Analysis {
  ...
  Duration get latency =>
      calls.fold(Duration.zero, (sum, c) => sum + c.latency);
}
