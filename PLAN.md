...
- [x] A15 README documents setup, keys, model licence, privacy and limits. Proof: `README.md` (screenshots rendered from synthetic sample data in `docs/screenshots/`).
