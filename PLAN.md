...
Delivery target: PR
Delivery: Pending — the alpha (A1 to A19) merged to `main` by the owner through https://github.com/sgaabdu4/capture/pull/1 on 2026-09-18 as 3b26239; its PR CI run passed in 338 s and the `main` CI run passed. A20 to A22 are in a second PR from `feature/capture-alpha`; after it merges, the Release workflow must publish the first DMG pre-release.
